...
export const impressumContent = {
  mk: {
    ...
    about: [
      ...
      'Победничкиот тим „ЕКОСКОПЈЕ 2“ — составен од млади со енергија, знаење и желба да придонесат — понуди практичен пристап: поврзување на граѓанските пријави, податоците од терен и институционалната реакција во една функционална дигитална платформа. Концептот што започна како инокамп предизвик е на пат да стане решение кое може да им служи и на граѓаните и на институциите.',
      'SkopYEAH! покажа дека младите не треба да се гледаат само како идни корисници на градските политики, туку како нивни активни создавачи. Кога им се дава јасен предизвик и поддршка, тие создаваат решенија конкретни, применливи и длабоко поврзани со градот во кој живеат, учат и се движат секој ден.',
    ],
    creatorsTitle: 'Креатори на апликацијата',
    sourceLabel: 'Повеќе за SkopYEAH! Inokampот (ЛЕАД)',
  },
  en: {
    title: 'Impressum',
    subtitle: 'Еко Скопје · SkopYEAH! Inokamp',
    ...
    about: [
      ...
      'The winning team “EKOSKOPJE 2” — young people with energy, knowledge and a desire to contribute — offered a practical approach: connecting citizen reports, field data and institutional response in one functional digital platform. A concept that started as an inokamp challenge is on its way to becoming a solution that can serve both citizens and institutions.',
      'SkopYEAH! showed that young people should not be seen only as future users of city policies, but as their active creators. When given a clear challenge and support, they build solutions that are concrete, applicable and deeply connected to the city they live, study and move through every day.',
    ],
    creatorsTitle: 'Application creators',
    sourceLabel: 'More about SkopYEAH! Inokamp (LEAD)',
  },
  sq: {
    title: 'Impresum',
    subtitle: 'Еко Скопје · SkopYEAH! Inokamp',
    ...
    about: [
      ...
      'Ekipi fitues “EKOSKOPJE 2” — të rinj me energji, dije dhe dëshirë për të kontribuar — ofroi një qasje praktike: lidhjen e raporteve qytetare, të dhënave nga terreni dhe reagimit institucional në një platformë digjitale funksionale. Një koncept që filloi si sfidë inokampi është në rrugë të bëhet zgjidhje që u shërben si qytetarëve ashtu edhe institucioneve.',
      'SkopYEAH! tregoi se të rinjtë nuk duhet të shihen vetëm si përdorues të ardhshëm të politikave urbane, por si krijuesit e tyre aktivë. Kur u jepet sfidë e qartë dhe mbështetje, ata ndërtojnë zgjidhje konkrete, të zbatueshme dhe thellësisht të lidhura me qytetin ku jetojnë, studiojnë dhe lëvizin çdo ditë.',
    ],
    creatorsTitle: 'Krijuesit e aplikacionit',
    sourceLabel: 'Më shumë për SkopYEAH! Inokamp (LEAD)',
  },
}
