...
export function Toast({ toast, onClose }) {
  ...
  return createPortal(
    <div className='pointer-events-none fixed inset-x-4 bottom-[calc(5.75rem+env(safe-area-inset-bottom,0px))] z-[1300] flex justify-end sm:inset-x-auto sm:right-4 lg:bottom-3'>
      <div
        role='status'
        aria-live='polite'
        onClick={dismiss}
