...
echo "   Потоа во Xcode: избери Signing Team и притисни Run (⌘R)."
echo ""
echo "ℹ️  За PUSH нотификации види ги чекорите во README (GoogleService-Info.plist,"
echo "   Push Notifications + Background Modes capabilities, APNs клуч во Firebase)."
